...
export default function SelectionDisplay({show}: SelectionToStringDisplayProps) {
  ...
  return (
    <DisplayContainer title="Selection Text (selectionToString)" showInitial={!show}>
      <strong>selectionToString:</strong>  { selectionToString }
      <br/>
      <strong>selectionAnchorNode:</strong> { stringRepresentationOfNode(selectionAnchorNode) }
      <br/>
      <strong>selectionAnchorOffset:</strong>  { selectionAnchorOffset }
      <br/>
      <strong>selectionFocusNode:</strong>  { stringRepresentationOfNode(selectionFocusNode) }
      <br/>
      <strong>selectionFocusOffset:</strong> { selectionFocusOffset }
    </DisplayContainer>
  )
